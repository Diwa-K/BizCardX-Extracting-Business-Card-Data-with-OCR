...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://e0.pxfuel.com/wallpapers/250/902/desktop-wallpaper-beige-minimal-minimalist-brown.jpg");
                        background-size: cover}}
                     </style>""",unsafe_allow_html=True) 
setting_bg()

# CREATING OPTION MENU
selected = option_menu(None, ["About","Upload & Extract","Modify"], 
...
if selected == "About":
    ...
    with col1:
        st.markdown("## :blue[**Overview :**] This Streamlit application developed for business card processing seamlessly integrates easyOCR for information extraction and a database (SQLite or MySQL) for data storage. Its user-friendly interface guides users through image upload, information extraction, and database operations (Create, Read, Update, Delete). The application efficiently manages multiple entries, displaying extracted data in an organized manner. With a carefully designed architecture, scalable features, and clear documentation, it offers a comprehensive solution for extracting, displaying, and managing business card information.")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join("C:/Users/Diwa/Desktop/DS/python/uploaded_cards",uploaded_card.name), "wb") as f:
